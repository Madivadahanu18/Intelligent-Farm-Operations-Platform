...
const FarmerMenu = () => {
  ...
  return (
    ...
    >
      <div
        className="farmer-menu-container"
        style={{
      ...
      >
        <div className="menu-header">
          ...
          >
            Your Digital Agriculture Control Center
          </p>
        </div>
        ...
        <div className="dashboard-grid">
          ...
          >
            ...
            <div className="card-content">
              ...
              <p className="card-description">
                Register new farm plots, classify soil types, and track area
                details across your registered land.
              </p>
          ...
          >
            ...
            <div className="card-content">
              ...
              <p className="card-description">
                Record new crop items, track sowing/harvest months, and log
                yields of active plots.
              </p>
              <div className="card-actions">
                <button
                  className="btn btn-success"
